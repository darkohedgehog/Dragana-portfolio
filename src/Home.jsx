    ...
    <div className="w-full lgl:w-[85%] h-full lgl:h-[85%] bg-transparent text-white z-50 flex items-start justify-between p-4 lgl:p-0">
      ...
      <div className="w-16 h-96 bg-transparent hidden lgl:flex flex-col gap-4">
        ...
        <div className="w-full h-80 bg-bodyColor rounded-3xl flex flex-col items-center justify-between py-6">
          ...
          <a
          href="viber://add?number=+381638307640"
          target="blank"
          className="w-full h-6 text-textColor text-xl flex items-center justify-center hover:text-emerald-400 duration-300 cursor-pointer relative group">
            <FaViber />
            <span className="text-black font-medium text-xs uppercase bg-emerald-400 px-4 py-[1px] rounded-xl absolute left-0 translate-x-8 group-hover:translate-x-12 opacity-0 group-hover:opacity-100 transition-all duration-300 z-20">
              Call via Viber
            </span>
